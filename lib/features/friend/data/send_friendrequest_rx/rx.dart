...
import 'package:llr/features/friend/data/send_friendrequest_rx/api.dart';
...
final class RequestSenerRx extends RxResponseInt<AcceptModel> {
  String? errorMessage;
  final api = RequestSenderApi.instance;

  RequestSenerRx({required super.empty, required super.dataFetcher});

  ValueStream get getFileData => dataFetcher.stream;

  Future<bool> sender({required String id}) async {
    try {
      final data = await api.sender(reciverId: id);
