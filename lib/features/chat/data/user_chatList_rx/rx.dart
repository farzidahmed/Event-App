...
import 'package:llr/features/chat/data/user_chatList_rx/api.dart';
...
final class UserChatListRx extends RxResponseInt<UserListModel> {
  UserChatListRx({required super.empty, required super.dataFetcher});

  ValueStream get allAlumbs => dataFetcher.stream;
  final api = UserChatListApi.instance;

  Future<UserListModel> userList() async {
    try {
      final data = await api.userList();
