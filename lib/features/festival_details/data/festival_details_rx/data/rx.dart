...
import 'package:llr/features/festival_details/data/festival_details_rx/data/api.dart';
...
final class AllAlumsDetailsRx extends RxResponseInt<AllAlumbsDetailsModel> {
  AllAlumsDetailsRx({required super.empty, required super.dataFetcher});

  ValueStream get allAlumbs => dataFetcher.stream;
  final api = AllAlumsDetailsApi.instance;

  Future<AllAlumbsDetailsModel> details(int id) async {
    try {
      final data = await api.details(id);
