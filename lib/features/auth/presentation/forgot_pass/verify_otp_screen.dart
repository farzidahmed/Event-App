...
class VerifyOtpResetPassor extends StatefulWidget {
  final String email;
  const VerifyOtpResetPassor({super.key, required this.email});

  @override
  State<VerifyOtpResetPassor> createState() => _VerifyOtpResetPassorState();
}

class _VerifyOtpResetPassorState extends State<VerifyOtpResetPassor> {
